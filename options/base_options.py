...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--cloud_masks', type=str, default='s2cloudless_mask', help='chooses which cloud algorithm to use.')
        parser.add_argument('--model', type=str, default='temporal_branched', help='chooses which model to use.')
        ...
        parser.add_argument('--include_S1', action='store_true', help='include SAR data')
        parser.add_argument('--in_only_S1', action='store_true', help='whether to train on S1 inputs only. This may be used for SAR->Optical domain translation tasks.')
        parser.add_argument('--use_perceptual_loss', action='store_true', help='use perceptual loss in training')
        parser.add_argument('--vgg16_path', type=str, default='none', help='the path of pretrained VGG16 network')
        ...
        parser.add_argument('--dataset_mode', type=str, default='sen12mscrts', help='chooses how datasets are loaded.')
        ...
        parser.add_argument('--layers_percep', type=str, default='original', help='layers of VGG16 to use for the perceptual loss (choose: dip, video, original, experimental)')
        ...
        parser.add_argument('--benchmark_resnet_model', action='store_true', help='whether to use the single time point ResNet model during testing')
        # cloud coverage
        parser.add_argument('--min_cov', type=float, default=0.0, help='minimum acceptable cloud coverage')
        parser.add_argument('--max_cov', type=float, default=1.0, help='maximum acceptable cloud coverage')
        # data set handling
        parser.add_argument('--import_data_path', type=str, default='', help='Path to file containing split for data loader import')
        parser.add_argument('--export_data_path', type=str, default='', help='Path to file containing split for data loader export')
